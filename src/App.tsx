...
const translations = {
  es: {
    ...
    termsText:
      'TÉRMINOS Y CONDICIONES · DESAFÍO FLINBOOST\n\nOBJETO DEL DESAFÍO\nEl programa "Flinboost" es una acción promocional organizada por Flinbo destinada a creadoras seleccionadas o aprobadas por la plataforma, mediante la cual podrán acceder a un bonus económico sujeto al cumplimiento de determinadas condiciones comerciales y de comportamiento dentro de la plataforma.\n\nDURACIÓN\nEl desafío tendrá una duración total de quince (15) días corridos desde la fecha de activación informada por Flinbo a la creadora participante.\n\nCONDICIONES PARA ACCEDER AL BONUS\nPara ser elegible al bonus promocional, la creadora deberá generar un mínimo de USD $30 (treinta dólares estadounidenses) en ventas válidas de contenido dentro de la plataforma Flinbo durante el período del desafío.\n\nCumplido dicho objetivo y luego de la correspondiente revisión interna, Flinbo otorgará un bonus adicional de USD $50 (cincuenta dólares estadounidenses), alcanzando un total equivalente a USD $80 entre ventas y bonus promocional.\n\nVALIDACIÓN Y REVISIÓN DE ACTIVIDAD\nTodas las ventas, movimientos y actividades relacionadas con el desafío estarán sujetas a revisión manual y/o automática por parte de Flinbo.\n\nFlinbo se reserva el derecho de descalificar participantes y cancelar el bonus, total o parcialmente, en caso de detectar:\n• Compras propias o auto-recargas.\n• Actividad fraudulenta o sospechosa.\n• Uso de cuentas duplicadas, falsas o vinculadas entre sí.\n• Manipulación artificial de ventas, tráfico o interacciones.\n• Incumplimiento de políticas internas o términos generales de la plataforma.\n• Conductas abusivas, engañosas o contrarias al normal funcionamiento del servicio.\n\nLa decisión de Flinbo respecto a la validez de las ventas y elegibilidad del bonus será final e inapelable.\n\nCONTENIDO Y CUMPLIMIENTO DE POLÍTICAS\nLa creadora participante deberá mantener su cuenta activa y cumplir en todo momento con las normas de contenido, moderación, copyright, comportamiento y uso establecidas por Flinbo.\n\nFlinbo podrá suspender, limitar o cancelar la participación de cualquier cuenta que:\n• Publique contenido prohibido o ilegal.\n• Infrinja derechos de terceros.\n• Reciba reportes graves o reiterados.\n• Sea bloqueada, suspendida o eliminada durante el período del desafío.\n\nPAGO DEL BONUS\nEl bonus promocional será abonado únicamente una vez finalizado el período del desafío y luego de completadas las verificaciones correspondientes por parte de Flinbo.\n\nEl pago podrá efectuarse dentro de los treinta (30) días hábiles posteriores a la finalización del desafío.\n\nFlinbo podrá retener temporalmente pagos en caso de auditorías internas, investigaciones de seguridad o verificaciones adicionales.\n\nMODIFICACIONES Y CANCELACIÓN\nFlinbo se reserva el derecho de modificar, suspender, limitar o cancelar el desafío total o parcialmente en cualquier momento, especialmente ante situaciones de fraude, abuso, problemas técnicos, fuerza mayor o cualquier circunstancia que afecte el correcto funcionamiento de la promoción.\n\nLIMITACIÓN DE RESPONSABILIDAD\nFlinbo no será responsable por pérdidas indirectas, interrupciones, fallos técnicos, errores de terceros, problemas de conexión, bloqueos externos, ni por cualquier situación ajena al control razonable de la plataforma que pudiera afectar la participación en el desafío o el otorgamiento del bonus.\n\nACEPTACIÓN\nLa participación en el desafío implica la lectura, comprensión y aceptación total de los presentes términos y condiciones.',
  ...
  en: {
    ...
    termsText:
      'TERMS AND CONDITIONS · FLINBOOST CHALLENGE\n\nPURPOSE\nThe "Flinboost" program is a promotional action organized by Flinbo for selected or approved creators on the platform, through which they can access a financial bonus subject to meeting certain commercial and behavioral conditions within the platform.\n\nDURATION\nThe challenge will have a total duration of fifteen (15) calendar days from the activation date communicated by Flinbo to the participating creator.\n\nCONDITIONS TO ACCESS THE BONUS\nTo be eligible for the promotional bonus, the creator must generate a minimum of USD $30 (thirty US dollars) in valid content sales within the Flinbo platform during the challenge period.\n\nOnce this goal is met and after the corresponding internal review, Flinbo will grant an additional bonus of USD $50 (fifty US dollars), reaching a total equivalent to USD $80 between sales and promotional bonus.\n\nVALIDATION AND ACTIVITY REVIEW\nAll sales, movements and activities related to the challenge will be subject to manual and/or automatic review by Flinbo.\n\nFlinbo reserves the right to disqualify participants and cancel the bonus, in whole or in part, if it detects:\n• Self-purchases or self-top-ups.\n• Fraudulent or suspicious activity.\n• Use of duplicate, fake or linked accounts.\n• Artificial manipulation of sales, traffic or interactions.\n• Violation of internal policies or general platform terms.\n• Abusive, misleading or disruptive behavior.\n\nFlinbo\'s decision regarding the validity of sales and bonus eligibility will be final and non-appealable.\n\nCONTENT AND POLICY COMPLIANCE\nThe participating creator must keep their account active and comply at all times with the content, moderation, copyright, behavior and usage standards established by Flinbo.\n\nFlinbo may suspend, limit or cancel the participation of any account that:\n• Publishes prohibited or illegal content.\n• Infringes third-party rights.\n• Receives serious or repeated reports.\n• Is blocked, suspended or deleted during the challenge period.\n\nBONUS PAYMENT\nThe promotional bonus will be paid only after the challenge period has ended and the corresponding verifications have been completed by Flinbo.\n\nPayment may be made within thirty (30) business days following the end of the challenge.\n\nFlinbo may temporarily withhold payments in case of internal audits, security investigations or additional verifications.\n\nMODIFICATIONS AND CANCELLATION\nFlinbo reserves the right to modify, suspend, limit or cancel the challenge in whole or in part at any time, especially in cases of fraud, abuse, technical issues, force majeure or any circumstance affecting the proper functioning of the promotion.\n\nLIMITATION OF LIABILITY\nFlinbo shall not be liable for indirect losses, interruptions, technical failures, third-party errors, connection problems, external blocks, or any situation beyond the platform\'s reasonable control that could affect participation in the challenge or the granting of the bonus.\n\nACCEPTANCE\nParticipation in the challenge implies the full reading, understanding and acceptance of these terms and conditions.',
  ...
  pt: {
    ...
    termsText:
      'TERMOS E CONDIÇÕES · DESAFIO FLINBOOST\n\nOBJETO DO DESAFIO\nO programa "Flinboost" é uma ação promocional organizada pela Flinbo destinada a criadoras selecionadas ou aprovadas pela plataforma, por meio da qual poderão acessar um bônus financeiro sujeito ao cumprimento de determinadas condições comerciais e de comportamento dentro da plataforma.\n\nDURAÇÃO\nO desafio terá duração total de quinze (15) dias corridos a partir da data de ativação informada pela Flinbo à criadora participante.\n\nCONDIÇÕES PARA ACESSAR O BÔNUS\nPara ser elegível ao bônus promocional, a criadora deverá gerar no mínimo USD $30 (trinta dólares americanos) em vendas válidas de conteúdo dentro da plataforma Flinbo durante o período do desafio.\n\nCumprida essa meta e após a correspondente revisão interna, a Flinbo concederá um bônus adicional de USD $50 (cinquenta dólares americanos), totalizando USD $80 entre vendas e bônus promocional.\n\nVALIDAÇÃO E REVISÃO DE ATIVIDADE\nTodas as vendas, movimentações e atividades relacionadas ao desafio estarão sujeitas a revisão manual e/ou automática pela Flinbo.\n\nA Flinbo se reserva o direito de desclassificar participantes e cancelar o bônus, total ou parcialmente, caso detecte:\n• Compras próprias ou auto-recargas.\n• Atividade fraudulenta ou suspeita.\n• Uso de contas duplicadas, falsas ou vinculadas entre si.\n• Manipulação artificial de vendas, tráfego ou interações.\n• Descumprimento de políticas internas ou termos gerais da plataforma.\n• Condutas abusivas, enganosas ou contrárias ao funcionamento normal do serviço.\n\nA decisão da Flinbo quanto à validade das vendas e elegibilidade do bônus será final e irrecorrível.\n\nCONTEÚDO E CUMPRIMENTO DE POLÍTICAS\nA criadora participante deverá manter sua conta ativa e cumprir em todo momento as normas de conteúdo, moderação, direitos autorais, comportamento e uso estabelecidas pela Flinbo.\n\nA Flinbo poderá suspender, limitar ou cancelar a participação de qualquer conta que:\n• Publique conteúdo proibido ou ilegal.\n• Infrinja direitos de terceiros.\n• Receba denúncias graves ou reiteradas.\n• Seja bloqueada, suspensa ou excluída durante o período do desafio.\n\nPAGAMENTO DO BÔNUS\nO bônus promocional será pago somente após o encerramento do período do desafio e a conclusão das verificações correspondentes pela Flinbo.\n\nO pagamento poderá ser efetuado dentro de trinta (30) dias úteis após o encerramento do desafio.\n\nA Flinbo poderá reter temporariamente pagamentos em caso de auditorias internas, investigações de segurança ou verificações adicionais.\n\nMODIFICAÇÕES E CANCELAMENTO\nA Flinbo se reserva o direito de modificar, suspender, limitar ou cancelar o desafio total ou parcialmente a qualquer momento, especialmente diante de situações de fraude, abuso, problemas técnicos, força maior ou qualquer circunstância que afete o correto funcionamento da promoção.\n\nLIMITAÇÃO DE RESPONSABILIDADE\nA Flinbo não será responsável por perdas indiretas, interrupções, falhas técnicas, erros de terceiros, problemas de conexão, bloqueios externos, nem por qualquer situação fora do controle razoável da plataforma que possa afetar a participação no desafio ou a concessão do bônus.\n\nACEITAÇÃO\nA participação no desafio implica a leitura, compreensão e aceitação total dos presentes termos e condições.',
    ...
    <main className="page">
      ...
      <footer className="footer">
        <div className="footerLinks">
          <a href="https://flinbo.com" target="_blank" rel="noreferrer" className="footerLink">
            Flinbo.com
          </a>
